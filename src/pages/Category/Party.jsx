...
const Partywear = () => {
  const [partywearData, setPartywearData] = useState([]);
  const dispatch = useDispatch();

  useEffect(() => {
    fetch("http://localhost:3000/partywear")
      .then((response) => response.json())
      .then((data) => setPartywearData(data))
      .catch((error) => console.error("Error fetching partywear data:", error));
  }, []);
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.title}>Party Wear</h1>
